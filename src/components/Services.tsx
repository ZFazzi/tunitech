        ...
        <div className="relative">
          <div className="px-8 md:px-12">
            ...
            >
              ...
              <CarouselPrevious className="absolute -left-4 top-1/2 -translate-y-1/2 bg-black/50 border-white/20 hover:bg-white/10 text-white h-10 w-10" />
              <CarouselNext className="absolute -right-4 top-1/2 -translate-y-1/2 bg-black/50 border-white/20 hover:bg-white/10 text-white h-10 w-10" />
            </Carousel>
          </div>
        </div>
      </div>
